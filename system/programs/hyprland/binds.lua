...
hl.bind(mod .. " + X", hl.dsp.window.fullscreen())
...
hl.bind(mod .. " + Escape", hl.dsp.exec_cmd(toggle("wlogout") .. " -b 4 -p layer-shell"))
hl.bind(mod .. " + E", hl.dsp.exec_cmd("uwsm app -- pcmanfm"))
hl.bind(mod .. " + L", hl.dsp.exec_cmd("loginctl lock-session"))
hl.bind(mod .. " + I", hl.dsp.exec_cmd("loginctl lock-session"))
hl.bind(mod .. " + O", hl.dsp.exec_cmd(runOnce("wl-ocr")))
hl.bind(mod .. " + V", hl.dsp.exec_cmd(toggle("pwvucontrol")))
hl.bind("XF86Favorites", hl.dsp.exec_cmd(runOnce("wl-ocr")))
hl.bind("XF86Calculator", hl.dsp.exec_cmd(toggle("qalculate-qt")))
hl.bind(mod .. " + Z", hl.dsp.exec_cmd("pypr zoom ++0.5"))
hl.bind(mod .. " + SHIFT + Z", hl.dsp.exec_cmd("pypr zoom"))
...
hl.bind("ALT + l", hl.dsp.focus({ direction = "l" }))
hl.bind("ALT + r", hl.dsp.focus({ direction = "r" }))
hl.bind("ALT + u", hl.dsp.focus({ direction = "u" }))
hl.bind("ALT + d", hl.dsp.focus({ direction = "d" }))
